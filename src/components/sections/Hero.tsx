    ...
    <section className="relative overflow-hidden pt-28">
      <div className="absolute inset-0 -z-20">
        <Image
          ...
          alt="Premium IPTV streaming on smart TV, tablet, and smartphone"
          fill
          priority
          sizes="100vw"
      ...
      <div className="absolute inset-0 -z-10 bg-gradient-to-r from-slate-950 via-slate-950/30 to-transparent" />
