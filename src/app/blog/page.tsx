...
export const metadata: Metadata = {
  ...
  description:
    "Complete IPTV guides for Smart TV, Fire Stick, Android TV, and mobile from qwevo tv. Fix buffering, compare plans, and find top apps for smooth streaming on any device.",
  alternates: {
